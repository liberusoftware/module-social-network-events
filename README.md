...
[![Latest release](https://img.shields.io/github/v/release/liberusoftware/module-social-network-events?sort=semver)](https://github.com/liberusoftware/module-social-network-events/releases/latest) [![Tests](https://github.com/liberusoftware/module-social-network-events/actions/workflows/tests.yml/badge.svg?branch=main)](https://github.com/liberusoftware/module-social-network-events/actions/workflows/tests.yml)
...
```bash
composer require liberusoftware/module-social-network-events
```
...
<a href="https://github.com/liberusoftware/module-social-network-events/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=liberusoftware/module-social-network-events" alt="Contributors to liberusoftware/module-social-network-events">
</a>

[View the full contributors graph](https://github.com/liberusoftware/module-social-network-events/graphs/contributors).
